...
//        'http://cdn.staticfile.org/font-awesome/4.7.0/css/font-awesome.min.css',
        'bower_components/font-awesome/css/font-awesome.min.css',  // <!-- Font Awesome 字体图标 -->
        'bower_components/Ionicons/css/ionicons.min.css',  // <!-- Ionicons -->
//        'bower_components/jvectormap/jquery-jvectormap.css',  // <!-- jvectormap 地图插件 -->
...
//        'bower_components/fastclick/lib/fastclick.js',  // <!-- FastClick 点击插件 -->
        'AdminLTE/dist/js/adminlte.min.js',  // <!-- AdminLTE App 框架js -->
//        'bower_components/jquery-sparkline/dist/jquery.sparkline.min.js',  // <!-- Sparkline 图表插件 -->
//        'plugins/jvectormap/jquery-jvectormap-1.2.2.min.js',  // <!-- jvectormap 地图控件 -->
//        'plugins/jvectormap/jquery-jvectormap-world-mill-en.js',  // <!-- jvectormap 地图插件 -->
//        'bower_components/jquery-slimscroll/jquery.slimscroll.min.js',  // <!-- SlimScroll 侧边滚动条 -->
//        'bower_components/chart.js/Chart.js',  // <!-- ChartJS 图表插件 -->
